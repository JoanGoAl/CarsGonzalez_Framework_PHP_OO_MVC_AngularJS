            ...
            info.forEach(element => {
                setTimeout(() => {
                    let popup = new mapboxgl.Popup({ closeOnClick: true })
                        .setHTML(
                            '<p>' + element.name_brand + ' ' + element.name_model + '</p><img class="redirectPopup" src="frontend/' + element.photo_car + '" alt=""><a class="popupRedirect" href="#/details/' + element.id_car + '">Pusle aqui para ver el coche</a>'
                        )
